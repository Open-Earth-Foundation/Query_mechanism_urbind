...
from backend.modules.writer.utils.research_curator import run_writer_research_curator
...
def write_markdown(
    ...
    curator_result = run_writer_research_curator(
        question=question,
    ...
    writer_context_bundle = curator_result.context_bundle
