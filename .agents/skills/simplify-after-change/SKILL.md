...
description: Mandatory after code changes to simplify the changed files without altering behavior. Use after adding, editing, deleting, or refactoring code to remove indirection, dead code, redundant typing, and unnecessary complexity.
---
