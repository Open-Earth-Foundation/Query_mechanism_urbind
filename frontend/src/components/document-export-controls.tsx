...
import { downloadRunWordExport, downloadRunWriterContextExport } from "@/lib/api";
...
export function DocumentExportControls({
  ...
  const [activeAction, setActiveAction] = useState<"context" | "word" | "notion" | null>(null);
